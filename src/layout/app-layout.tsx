...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bees', path: '/bees', entity: 'bee', service: AccessServiceEnum.PROJECT, icon: FiFeather },
    { name: 'Harvests', path: '/harvests', entity: 'harvest', service: AccessServiceEnum.PROJECT, icon: FiSunrise },
    {
      name: 'Health Checks',
      path: '/health-checks',
      entity: 'health_check',
    ...
    { name: 'Hives', path: '/hives', entity: 'hive', service: AccessServiceEnum.PROJECT, icon: FiHome },
