...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'hive_added.create': { roles: ['beekeeper'], key: 'hive', tenantPath: [], userPath: [] },
  'visit_booked.create': { roles: ['beekeeper'], key: 'visit', tenantPath: [], userPath: [] },
  'hive_removed.delete': { roles: ['beekeeper'], key: 'hive', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['beekeeper'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['beekeeper'];
