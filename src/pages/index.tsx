...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`My beehive tracker`}</title>

        <meta
          name="description"
          content="My Beehive Tracker - Empowering beekeepers with real-time insights into their hives, fostering healthier bees and sweeter honey"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1581271064038-11cf1c43a0b2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiZWVzfGVufDB8fHx8MTY5NTMwODA4OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@scohron?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Shelby Cohron`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`My Beehive Tracker - Empowering beekeepers with real-time insights into their hives, fostering healthier bees and sweeter honey`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Beekeeper" type="beekeeper" abilities={appConfig.ownerAbilities} />
